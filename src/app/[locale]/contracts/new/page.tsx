...
export default function NewContractPage() {
  ...
  const [form, setForm] = useState<FormData>({
    partnerId: "", name: "", contractType: "", status: "draft",
    startDate: "", endDate: "", trialStartDate: "", goLiveDate: "",
    cities: "", workingDays: [], deliveryAttempts: "", proofType: "",
    shipmentEntryChannel: "", updateChannel: "", returnPolicy: "",
    azmResponsible: "", partnerResponsible: "", operationalNotes: "",
  });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const id = data.contract?._id ?? data._id;
  ...
  return (
    <DashboardLayout locale={locale} title={t("contracts.new")}>
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold tracking-tight text-gray-900">{t("contracts.new")}</h1>
