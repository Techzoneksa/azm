...
function Navbar({
  ...
  return (
    <header
      className={cn(
        "sticky top-0 z-20 flex h-16 items-center gap-4 border-b border-gray-200/80 bg-white/80 backdrop-blur-xl px-4 md:px-6",
        className
      )}
      {...props}
    >
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="relative" ref={dropdownRef}>
          ...
          >
            <div className="flex size-8 items-center justify-center rounded-full bg-gradient-to-br from-brand-orange to-brand-light-orange text-xs font-bold text-white shadow-sm">
          ...
          {dropdownOpen && (
            <div
              className={cn(
                "absolute top-full z-50 mt-2 w-48 rounded-xl border border-gray-200/80 bg-white py-1 shadow-dropdown animate-scale-in",
                isRtl ? "start-0" : "end-0"
              )}
            >
